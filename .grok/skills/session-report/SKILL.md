---
name: session-report
description: Generate an explorable HTML report of session usage (tokens, cache, subagents, skills, expensive prompts) from GROK_HOME/sessions transcripts on X:.
---
